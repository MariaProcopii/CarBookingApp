...
public record GetBookedRidesQuery(int UserId) : IRequest<List<RideShortInfoDTO>>;

public class GetBookedRidesQueryHandler : IRequestHandler<GetBookedRidesQuery, List<RideShortInfoDTO>>
{
    ...
    public async Task<List<RideShortInfoDTO>> Handle(GetBookedRidesQuery request, CancellationToken cancellationToken)
    {
