...
var React, import_prop_types, import_jsx_runtime, _excluded, useUtilityClasses, TabRoot, Tab, Tab_default;
var init_Tab = __esm({
  "node_modules/@mui/material/Tab/Tab.js"() {
    "use client";
    init_objectWithoutPropertiesLoose();
    ...
    _excluded = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
    ...
    Tab = React.forwardRef(function Tab2(inProps, ref) {
...
var React2, import_jsx_runtime2, KeyboardArrowLeft_default;
var init_KeyboardArrowLeft = __esm({
  "node_modules/@mui/material/internal/svg-icons/KeyboardArrowLeft.js"() {
    ...
    KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime2.jsx)("path", {
...
var React3, import_jsx_runtime3, KeyboardArrowRight_default;
var init_KeyboardArrowRight = __esm({
  "node_modules/@mui/material/internal/svg-icons/KeyboardArrowRight.js"() {
    ...
    KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime3.jsx)("path", {
...
var React4, import_prop_types2, import_jsx_runtime4, _excluded2, useUtilityClasses2, TabScrollButtonRoot, TabScrollButton, TabScrollButton_default;
var init_TabScrollButton = __esm({
  "node_modules/@mui/material/TabScrollButton/TabScrollButton.js"() {
    ...
    _excluded2 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var React5, import_prop_types3, import_jsx_runtime5, _excluded3, styles;
...
var React6, import_react_is, import_prop_types4, import_jsx_runtime6, import_jsx_runtime7, _excluded4, nextItem, previousItem, moveFocus, useUtilityClasses3, TabsRoot, TabsScroller, FlexContainer, TabsIndicator, TabsScrollbarSize, defaultIndicatorStyle, warnedOnceTabPresent, Tabs, Tabs_default;
var init_Tabs = __esm({
  "node_modules/@mui/material/Tabs/Tabs.js"() {
    "use client";
    init_objectWithoutPropertiesLoose();
    ...
    _excluded4 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
    nextItem = (list, item) => {
      if (list === item) {
...
//# sourceMappingURL=chunk-UIZNT4P4.js.map
